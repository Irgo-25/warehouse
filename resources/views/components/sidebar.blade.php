        ...
        <ul class="space-y-2 font-medium mt-3">
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">User Manajement</span>
            ...
            <li>
                <x-nav-link href="{{route('categoryProduct')}}" :active="request()->routeIs('categoryProduct')">
            ...
            <li>
                <x-nav-link href="{{route('listBarangMasuk')}}" :active="request()->routeIs('listBarangMasuk')">
                    <span class="flex-1 ms-3 whitespace-nowrap">Incoming Goods</span>
                </x-nav-link>
            </li>
            <li>
                <x-nav-link href="{{route('listBarangKeluar')}}" :active="request()->routeIs('listBarangKeluar')">
                    <span class="flex-1 ms-3 whitespace-nowrap">Outgoing Goods</span>
                </x-nav-link>
            </li>
            <li>

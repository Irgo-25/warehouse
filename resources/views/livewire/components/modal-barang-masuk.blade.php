        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-3/4 lg:w-1/4 sm:w-1/2 md:w-1/4">
            ...
            <div class="p-2">
                <form wire:submit.prevent="submit">
                    ...
                    <div class="mb-3">
                        <label class="text-base font-medium block mb-2" for="stock">Stock Sekarang</label>
                        <x-input type="number" value="{{$stock}}" disabled />
                        <div class="text-red-600">@error('stock') {{ $message }} @enderror</div>
                    </div>
                    <div class="mb-3">

<div>
    <button wire:click="openModal" class="text-sm font-semibold px-2 py-1.5 bg-blue-700 text-white rounded">
        Export
    </button>
    <!-- Modal -->
    @if ($show)
    <div class="fixed z-30 overflow-y-auto inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-auto p-2">
            ...
            <!-- Modal body -->
            <form wire:submit.prevent="export" target="_blank" class="p-4 md:p-5">
                <div class="flex items-center">
                    <div>
                        ...
                        <div class="text-red-600 text-sm">@error('tanggalAwal') {{ $message }} @enderror</div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="text-red-600 text-sm">@error('tanggalAkhir') {{ $message }} @enderror</div>
                    </div>
                </div>
                <button type="submit"
